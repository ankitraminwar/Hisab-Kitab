      ...
      >
        ...
        <Card style={styles.nwCard} glow>
          ...
          <Text
            style={[
              styles.nwValue,
              { color: nw.netWorth >= 0 ? COLORS.income : COLORS.expense },
            ]}
          >
          ...
          <View style={styles.nwRow}>
            <View style={styles.nwStat}>
              ...
              <Text style={[styles.nwStatValue, { color: COLORS.income }]}>
                {formatCompact(nw.assets)}
              </Text>
            </View>
            <View style={styles.nwDivider} />
            <View style={styles.nwStat}>
              <View
                style={[styles.nwDot, { backgroundColor: COLORS.expense }]}
              />
              <Text style={styles.nwStatLabel}>Liabilities</Text>
              <Text style={[styles.nwStatValue, { color: COLORS.expense }]}>
          ...
          assetsByType.map((group) => (
            <Card key={group.key} style={styles.assetGroupCard}>
              <View style={styles.assetGroupHeader}>
                ...
                <Text style={[styles.assetGroupTotal, { color: group.color }]}>
                ...
                <View style={styles.liabilityRow}>
                  <View
                    style={[
                      ...
                      {
                        backgroundColor:
                          (typeInfo?.color || COLORS.expense) + '20',
                      },
                    ]}
                  >
                    <Ionicons
                      name={(typeInfo?.icon || 'card') as any}
                      size={16}
                  ...
                  <View style={styles.liabilityInfo}>
                    ...
                    {liability.interestRate > 0 && (
                      <Text style={styles.liabilityRate}>
                        {liability.interestRate}% p.a.
                      </Text>
                    )}
                  </View>
                  <Text
                    style={[styles.liabilityAmount, { color: COLORS.expense }]}
                  >
